...
export const researchRecords: ResearchRecord[] = [
  ...
  },
  {
    ...
    currentState: "Published research. The page focuses on the engineering question, mechanism, analytical reasoning, and simulation evidence without overstating implementation beyond the published work.",
  ...
  },
  {
    ...
    period: "Fall 2026",
    question: "The operational question is governed by the independent-study protocol and is intentionally not expanded beyond the approved scope.",
    ...
    evidence: [],
    currentState: "Active independent study. Public claims are limited to study materials and completed analysis rather than inferred from adjacent healthcare projects.",
