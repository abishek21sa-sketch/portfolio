    ...
    <main id="main-content">
      <section className="projects-hero">
        <div className="project-detail-inner">
          ...
          <h1>Projects</h1>
          <p className="projects-hero-copy">{flagshipProjects.length} flagship systems lead the portfolio. More engineering and research work stays available below—kept distinct by origin, then cross-explored by domain, mathematics, technology, data/AI, and maturity.</p>
      ...
      <section className="project-section explorer-section">
        <div className="project-detail-inner">
          ...
          <h2>Flagship systems first. More engineering and research stays discoverable.</h2>
